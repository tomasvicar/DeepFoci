...
% Last Modified by GUIDE v2.5 15-Feb-2019 08:52:18
...
global a_koef b_koef normyv reset Mdl_pom vys_stare 
...
global prah Mdl features vysledek pevne Mdl_pom
if ~isempty(features)
...
try
    if get(handles.checkbox6,'Value')
        ...
        cc1=plot(tecky(:,1), tecky(:,2), 'b*','MarkerSize',ms);
        cc2=plot(tecky(find(pouzite),1), tecky(find(pouzite),2), 'ro','MarkerSize',ms);
        cc3=plot(tecky(find(pouzite),1), tecky(find(pouzite),2), 'g*','MarkerSize',ms);
...
try
    if get(handles.checkbox6,'Value')
        cc4=plot(tecky(:,3), tecky(:,2), 'b*','MarkerSize',ms);
        cc5=plot(tecky(find(pouzite),3), tecky(find(pouzite),2), 'ro','MarkerSize',ms);
        cc6=plot(tecky(find(pouzite),3), tecky(find(pouzite),2), 'g*','MarkerSize',ms);
    end
end
hold off
...
try
    if get(handles.checkbox6,'Value')
        cc7=plot(tecky(:,1), tecky(:,3), 'b*','MarkerSize',ms);
        cc8=plot(tecky(find(pouzite),1), tecky(find(pouzite),3), 'ro','MarkerSize',ms);
        cc9=plot(tecky(find(pouzite),1), tecky(find(pouzite),3), 'g*','MarkerSize',ms);
