...
for k=1:length(soubory)
    ...
    featuress_whole=zeros(size(rg,1),21);
    ...
    for cislo_bunky=1:length(maskyv)
        ...
        [features_whole]=get_features_whole21(data,a,b, maska_krajena>0);
        ...
        featuress_whole(find(ktere),:)=features_whole;
...
%         end
        ...
        barvav.baravav3=barvav3;
         ...
         save([slozka '/vys_bunka' num2str(cislo_bunky,'%03d') '.mat'],'vys','vyss','pouzit','barvav','foky_rgvv','cislo_snimku','cislo_bunky','data','tecky','features','features_more','features_whole','normyv','smaz_foky_rgvv','pouzit','soubor_ulozit','mvv0','prah')
%         save([ukladaci_cesta '/bunky' pom_cislo '/pom_data' pom_cislo '/' num2str(k,'%03d') '-' num2str(cislo_bunky,'%03d') '/vysledky_b' num2str(cislo_bunky,'%03d') pom_cislo  '.mat'],'vys','vyss','pouzit','barvav','foky_rgvv','cislo_snimku','cislo_bunky','data','tecky','features','normyv','smaz_foky_rgvv','pouzit','soubor_ulozit','mvv0','prah')
    ...
    save([slozka '/vys_cele.mat'],'vysledek','bunka','featuress','featuress_more','featuress_whole','rg')
