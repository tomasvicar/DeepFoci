...
% cesta='../../../klikac_novy/ja/poloauto_nahodny_vzorek_tif_processed_unet_erod';
...
for k=151:length(soubory)%upravit 1 - pro pokraèování od jiného èísla
    k
    ...
    save([slozka '/vys_cele_nove.mat'],'vysledek','vys','featuress_cele21','data','rg','cislo_snimku','soubor_ulozit','prah')
