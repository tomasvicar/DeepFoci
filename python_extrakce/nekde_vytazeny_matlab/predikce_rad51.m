...
for data_folder_num = 1:length(data_folders)
    ...
    data_folder = data_folders{data_folder_num};
    error_folder = split(data_folder,'\');
    error_folder = [error_folder{end} '_prediction_rad51_2'];
    mkdir(error_folder)

    
    mkdir(error_folder)
    
    results_folder = [data_folder '_net_results_rad51_2'];
...
%     
    ...
    dlnet_detection = load('foci_detection_training/detection_model_rad51_2.mat');
