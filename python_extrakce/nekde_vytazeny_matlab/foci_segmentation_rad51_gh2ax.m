...
for data_folder_num = 1:length(data_folders)
    ...
    results_folder_res1 = [data_folder '_net_results_rad51_2'];

    error_folder = split(data_folder,'\');
    error_folder = [error_folder{end} '_foci_seg_rad51_2'];
    mkdir(error_folder)
    

    results_folder_oldseg = [data_folder '_net_results_oldseg'];

    results_folder_fociseg = [data_folder '_fociseg_rad51_2'];
    results_folder_examle_fociseg = [data_folder '_example_fociseg_rad51_2'];
    ...
    for file_num = 1193:length(filenames)%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
