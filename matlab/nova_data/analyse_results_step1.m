...
folders_detection = {...
    'C:\Data\Vicar\foky_final_cleaning\FOR ANALYSIS\Prioritně + 15N  ion tracks (originálně z Acquiarium) pro analýzu a nové učení\53BP1 + gH2AX_net_results_gH2AX',
    'C:\Data\Vicar\foky_final_cleaning\FOR ANALYSIS\Prioritně + 15N  ion tracks (originálně z Acquiarium) pro analýzu a nové učení\RAD51 + gH2AX_net_results_rad51',
    };
folders_cellseg = {...
    'C:\Data\Vicar\foky_final_cleaning\FOR ANALYSIS\Prioritně + 15N  ion tracks (originálně z Acquiarium) pro analýzu a nové učení_net_results_oldseg\53BP1 + gH2AX',
    'C:\Data\Vicar\foky_final_cleaning\FOR ANALYSIS\Prioritně + 15N  ion tracks (originálně z Acquiarium) pro analýzu a nové učení_net_results_oldseg\RAD51 + gH2AX',
    };
folders_fociseg = {...
    'C:\Data\Vicar\foky_final_cleaning\FOR ANALYSIS\Prioritně + 15N  ion tracks (originálně z Acquiarium) pro analýzu a nové učení\53BP1 + gH2AX_fociseg_rad51_gh2ax',
    'C:\Data\Vicar\foky_final_cleaning\FOR ANALYSIS\Prioritně + 15N  ion tracks (originálně z Acquiarium) pro analýzu a nové učení\RAD51 + gH2AX_fociseg_rad51_gh2ax',
    };


outputs_detection_chanelss = {{'points_53BP1','points_gH2AX','points_53BP1_gH2AX_overlap'},{'points_RAD51','points_gH2AX','points_53BP1_gH2AX_overlap'}};
