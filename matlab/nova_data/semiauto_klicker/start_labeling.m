...
folder_names = {...
    '../Prioritně + 15N  ion tracks (originálně z Acquiarium) pro analýzu a nové učení_labeling_new'
    };
...
step = 3;
for file_num = 1:step:length(filenames_sets)
    a = 'saved';
    save(['completed/' num2str(file_num,'%04.f') '.mat'],'a')
    filenames_part = [filenames_sets{file_num:file_num+step}];
