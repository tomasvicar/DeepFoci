...
%% setup
src_path = 'C:/Data/Vicar/foky_final_cleaning/FOR ANALYSIS/Prioritně + 15N  ion tracks (originálně z Acquiarium) pro analýzu a nové učení_resaved_labeled/53BP1 + gH2AX';
dst_paht = '../../../../data_gH2AX_resaved';
...
filenames.imgs_gH2AX = cellfun(@(x) replace(x,'53BP1.tif','gH2AX.tif'),filenames.imgs_53BP1,'UniformOutput',false);
filenames.imgs_DAPI = cellfun(@(x) replace(x,'53BP1.tif','DAPI.tif'),filenames.imgs_53BP1,'UniformOutput',false);
