...
for data_folder_num = 1:length(data_folders)
    ...
    data_folder = data_folders{data_folder_num};
    error_folder = split(data_folder,'\');
    error_folder = [error_folder{end} '_prediction_gH2AX'];
    mkdir(error_folder)

    
    mkdir(error_folder)
    
    results_folder = [data_folder '_net_results_gH2AX'];
...
%     
    ...
    dlnet_detection = load('foci_detection_training/detection_model_gH2AX.mat');
