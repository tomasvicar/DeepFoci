...
data_path = 'C:/Data/Vicar/foky_final_cleaning/FOR ANALYSIS/NANOREP_labeling_new_labeled_resaved';
data_path = dir(data_path).folder; % convert to absolute path - requered for loading

model_name = 'detection_model_rad51_2';


tmp_folder = ['C:/Data/Vicar/foky_final_cleaning/data_rad51_2_tmpmodels/tmp_' model_name];
mkdir(tmp_folder)
