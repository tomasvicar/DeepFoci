...
data_path = 'C:/Data/Vicar/foky_final_cleaning/data_gH2AX_resaved';
data_path = dir(data_path).folder; % convert to absolute path - requered for loading

model_name = 'detection_model_gH2AX';


tmp_folder = ['C:/Data/Vicar/foky_final_cleaning/data_gH2AX_tmpmodels/tmp_' model_name];
mkdir(tmp_folder)
