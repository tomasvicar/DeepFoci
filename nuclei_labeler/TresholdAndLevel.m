...
classdef TresholdAndLevel < vision.labeler.AutomationAlgorithm
    ...
    methods
       ...
       function autoLabels = run(algObj, I)
           ...
           % sky
           autoLabels = categorical(ones(size(I,1), size(I,2)),0:2,algObj.AllCategories,'Ordinal',true);
           II=I(:,:,3);
           level = graythresh(II(:));
           bin=II>level;
           ...
           binar = activecontour(II,bin,100,'Chan-Vese','SmoothFactor',2);
           
           

           autoLabels(binar>0) = 'cell';
       end
