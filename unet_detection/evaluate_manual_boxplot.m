...
%     name_gt_ja=strrep(name,'man_nahodny_vzorek_tif2','man_nahodny_vzorek_tif_ja');
%     name_gt_ja=strrep(name_gt_ja,'.tif','_tecky.mat');
%     
%     name_gt_jarda=strrep(name,'man_nahodny_vzorek_tif2','man_nahodny_vzorek_tif_jarda');
%     name_gt_jarda=strrep(name_gt_jarda,'.tif','_tecky.mat');
...
%     res_im=imread(save_unet_foci_segmentation_res);
    res_im=imread(save_unet_foci_segmentation_res_t29);
